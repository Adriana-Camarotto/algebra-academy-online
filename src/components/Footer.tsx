...
const Footer: React.FC = () => {
  ...
  return (
    <footer className="bg-tutor-dark text-white py-12">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            <h3 className="text-xl font-bold mb-4">{t('appName', language)}</h3>
          ...
          <div>
            <h3 className="text-xl font-bold mb-4">{t('servicesTitle', language)}</h3>
          ...
          <div>
            <h3 className="text-xl font-bold mb-4">{t('contact', language)}</h3>
            <address className="not-italic text-gray-300 space-y-2">
              <p>123 Math Avenue</p>
              <p>New York, NY 10001</p>
              <p>Email: info@mathtutorpro.com</p>
        ...
        <div className="mt-8 pt-8 border-t border-gray-700 flex flex-col md:flex-row justify-between items-center text-gray-400 text-sm">
          <p>&copy; {new Date().getFullYear()} {t('appName', language)}. {language === 'en' ? 'All rights reserved.' : 'Todos os direitos reservados.'}</p>
