        ...
        <div className="grid gap-4">
          {services.map((service) => (
            <div key={service.id}>
              ...
              {/* Lesson Type Selection for Primary School */}
              {selectedService === "primary-school" &&
                service.id === "primary-school" && (
                      ...
                      >
                        ...
                        <div className="text-sm text-gray-600">
                          {language === "en"
                            ...
                            : "Aula única - pagamento processado 24h antes da aula"}
                        </div>
                      </div>
                      <div
              ...
              {/* Lesson Type Selection for Secondary School */}
              {selectedService === "secondary-school" &&
                service.id === "secondary-school" && (
                  <div className="mt-4 ml-4 p-4 bg-gray-50 rounded-lg">
                    <h4 className="font-medium mb-3 flex items-center gap-2">
                      <Repeat className="h-4 w-4" />
                      {language === "en" ? "Lesson Type" : "Tipo de Aula"}
              ...
              {/* Lesson Type Selection for A-level */}
              {selectedService === "a-level" && service.id === "a-level" && (
                <div className="mt-4 ml-4 p-4 bg-gray-50 rounded-lg">
                  <h4 className="font-medium mb-3 flex items-center gap-2">
                    <Repeat className="h-4 w-4" />
                    {language === "en" ? "Lesson Type" : "Tipo de Aula"}
              ...
              {/* Lesson Type Selection for Individual Tutoring (Legacy - kept for compatibility) */}
