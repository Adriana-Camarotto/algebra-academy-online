...
const PaymentSuccessPage = () => {
  ...
  useEffect(() => {
    const getBookingDetails = async () => {
      ...
      const isMockMode =
        queryParams.get("mock") === "true" ||
        queryParams.get("direct") === "true";

      if (isMockMode) {
        console.log("PaymentSuccess: MOCK MODE - Creating fake booking data");
        const mockBooking = {
          id: bookingId,
      ...
      try {
        ...
        if (data) {
          ...
          if (data.payment_status === "pending") {
            ...
            if (updateError) {
              console.error(
                "PaymentSuccess: Error updating payment status:",
                updateError
              );
            } else {
              console.log(
  ...
  const getServiceName = (serviceType: string) => {
    const services = {
      ...
      "exam-prep":
        language === "en" ? "Exam Preparation" : "Preparação para Exames",
    };
