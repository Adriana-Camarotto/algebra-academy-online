...
import { useSupabaseAuth } from "@/hooks/useSupabaseAuthFixed";
  ...
  const handleLogin = async (email: string, password: string) => {
    ...
    try {
      ...
      if (!error) {
        ...
        // Aguarda um pouco para o estado sincronizar
        setTimeout(() => {
          ...
          if (user?.role === "student") {
            ...
            // Fallback baseado no papel selecionado
        ...
        }, 500); // Aguarda meio segundo para sincronização
      }
    } finally {
      setLoading(false);
    }
